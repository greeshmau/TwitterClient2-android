# Project 4 - *Twitter Client 2*

**Twitter Client 2** is an android app that allows a user to view home and mentions timelines, view user profiles with user timelines, as well as compose and post a new tweet. The app utilizes [Twitter REST API](https://developer.twitter.com/en/docs/api-reference-index).
...
* [ ] List anything else that you can get done to improve the app functionality!
    *[X] Added media/image under profile view with its own adapter

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='./twitter2Demo6.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
## License
    ...
    Copyright 2017 Codepath(Oauth)/Greeshma
